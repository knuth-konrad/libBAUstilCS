...
namespace libBAUtilCS
{
   ...
   public class FilesystemUtil
   {
      ...
      /// </returns>
      public static string DenormalizePath(string sPath, string sDelim = "\\", Boolean bolCheckTail = true)
      {
         if (bolCheckTail == true)
         {
            if (StringUtil.Right(sPath, sDelim.Length) != sDelim)
            {
               return sPath;
            }
            else
         ...
         {
            if (StringUtil.Left(sPath, sDelim.Length) != sDelim)
            {
               return sPath;
            }
            else
      ...
      /// </returns>
      public static string NormalizePath(string sPath, string sDelim = "\\", Boolean bolCheckTail = true)
      {
         if (bolCheckTail == true)
         {
            if (StringUtil.Right(sPath, sDelim.Length) != sDelim)
      ...
      /// </remarks>
      public static Boolean BackupFile(string fileSource, string fileDest, out string newFile, Boolean copyOnly = false,
         Boolean incrementTarget = true)
      {
