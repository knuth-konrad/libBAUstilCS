...
namespace libBAUtilCS
{
  ...
  public class StringHelper
  {
    ...
    /// <returns>Enclosed <paramref name="text"/></returns>
    public static string Wrap(string text, string leftChar, string rightChar = "")
    {
    ...
    /// <returns>Enclosed <paramref name="text"/></returns>
    public static string Wrap(string text, char wrapChar)
    {
    ...
    /// <returns>Enclosed <paramref name="text"/></returns>
    public static string Wrap(string text, char LeftChar, char rightChar)
    {
      return LeftChar + text + rightChar;
    }
    ...
    /// <param name="rightChar">Right 'bracket'. If <paramref name="rightChar"/> = "", <paramref name="leftChar"/> is used instead.</param>
    /// <returns>Enclosed <paramref name="text"/></returns>
    public static string UnWrap(string text, string leftChar, string rightChar = "")
    {
      ...
      if (text.Length > leftChar.Length && text.StartsWith(leftChar))
      {
      ...
      if (text.Length > leftChar.Length && text.EndsWith(leftChar))
      {
    ...
    /// <summary>
    /// Unwraps a string from <paramref name="wrapChar"/>
    /// </summary>
    /// <param name="text">Original string</param>
    /// <param name="wrapChar">'Bracket' character</param>
    /// <returns>Enclosed <paramref name="text"/></returns>
    public static string UnWrap(string text, char wrapChar)
    {
      ...
      if (text.Length > 1 && text.StartsWith(wrapChar.ToString()))
      {
        text = text.Substring(1);
      }

      if (text.Length > 1 && text.EndsWith(wrapChar.ToString()))
      {
